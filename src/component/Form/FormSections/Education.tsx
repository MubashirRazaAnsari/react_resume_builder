  ...
  return (
    <div className="max-w-lg mx-auto p-6 bg-white rounded-xl shadow-md mt-10">
      ...
      <p className="text-gray-600 mb-6">
        Fill out your Educational details below.
      </p>
      ...
      {userProfile.education.map((_education, index) => (
        <form key={index} className="space-y-4">
          <div
            key={index}
            className="border-b-slate-500 shadow-md p-3 rounded-md"
          >
            <div className="grid grid-cols-2 gap-4">
              <div>
                ...
                <input
                  ...
                  value={userProfile.education[index].passingYear}
                />
              </div>
              <div>
                <label
                ...
                <input
                  ...
                  value={userProfile.education[index].grade}
                />
              </div>
            </div>
            ...
            <div>
              ...
              <input
                ...
                value={userProfile.education[index].instituteName}
              />
            </div>
            ...
            <div>
              ...
              <input
                ...
                value={userProfile.education[index].degree}
              />
            </div>
          </div>
        </form>
      ...
      <button
        ...
        disabled={userProfile.education.length === 3}
